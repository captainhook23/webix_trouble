...
export default class ParkingsView extends JetView {
    deleteRows(_) {
        const datatable = $$('parkings_table');
    ...
    config() {
        ...
        this.ID = "parkings";
        this.label = _("parkingAdministration");

        checkAccess.checkAccess(this, role)
        const url = 'http://192.168.1.37:8085/wp-json/ppv/v1/admin_table_parking_administration';
        ...
        const searchbar = {
            ...
            on: {
                onSearchIconClick: function () {
                    ...
                    const datatable = $$('parkings_table'); // Reference the datatable
    ...
    init() {
        ...
        this.ui({
            ...
            position: function (state) {
                state.left = window.innerWidth - 43;
                state.top = window.innerHeight - 100;
                return state;
            },
                    ...
                    onItemClick: function (id) {
                        ...
                        switch (id) {
                            case 'png':
                                ...
                                break;
                            case 'excel':
                                webix.toExcel(datatable, { filename: 'parkings_table' });
                                break;
                            case 'csv':
                                webix.toCSV(datatable, { filename: 'parkings_table.csv' });
                                break;
                            case 'json':
                                const json = JSON.stringify(data, null, 2);
                                webix.html.download(json, 'parkings_table.json');
                                break;
                            default:
