        ...
        const table = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    sort: 'int',
                    width: 150,
                    header: [{ text: 'firstName' }, { content: 'selectFilter' }],
                },
                {
                    id: 'lastName',
                    sort: 'string',
                    header: [{ text: 'lastName' }, { content: 'selectFilter' }],
                    adjust: 'data',
                },
                {
                    id: 'visum',
                    sort: 'string',
                    header: [{ text: 'visum' }, { content: 'selectFilter' }],
                    adjust: 'data',
                },
                {
                    id: 'email',
                ...
                { id: 'role', sort: 'string', header: [{ text: 'role' }, { content: 'selectFilter' }], adjust: 'data' },
                {
                    id: 'credits',
                    sort: 'string',
                    header: [{ text: 'credits' }, { content: 'selectFilter' }],
                    adjust: 'data',
                },
                {
                    id: 'lastLogin',
                    sort: 'string',
                    header: [{ text: 'lastLogin' }, { content: 'selectFilter' }],
                    adjust: 'data',
                },
                {
                    id: 'registerDate',
                    sort: 'string',
                    header: [{ text: 'registerDate' }, { content: 'selectFilter' }],
                    adjust: 'data',
                },
                {
                    id: 'actions',
